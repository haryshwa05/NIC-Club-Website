...
import workshopsData from './Gaming.json'; // Import the JSON file
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center items-start h-full space-y-4 p-4 border-2 border-red-600 rounded-lg w-full box-border">
                      ...
                      <p className="flex items-center">
                        <Users className="w-4 h-4 mr-2" /> {/* Users icon */}
                        <strong>Faculty Coordinators:</strong> {workshop.facultyCoordinators}
                      </p>

                      {/* Student Coordinators with Users icon */}
                      <p className="flex items-center">
                        <Users className="w-4 h-4 mr-2" /> {/* Users icon */}
                        <strong>Student Coordinators:</strong> {workshop.studentCoordinators}
                      </p>
                    </div>
                  </div>
                </ReactCardFlip>
